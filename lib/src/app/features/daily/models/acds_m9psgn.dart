...
class AcdsM9psgnReport {
  ...
  factory AcdsM9psgnReport.fromMap(Map<String, dynamic> map) {
    return AcdsM9psgnReport(
      system: map['system'] ?? '',
      ...
      reportData: List<ReportDatum>.from(map['reportData']?.map((x) => ReportDatum.fromMap(x))),
    );
  }

  String toJson() => json.encode(toMap());

  factory AcdsM9psgnReport.fromJson(String source) => AcdsM9psgnReport.fromMap(json.decode(source));
  ...
  bool operator ==(Object other) {
    ...
    return other is AcdsM9psgnReport &&
      other.system == system &&
...
class ReportDatum {
  ...
  factory ReportDatum.fromMap(Map<String, dynamic> map) {
    return ReportDatum(
      ...
      columnInfo: List<ColumnInfo>.from(map['columnInfo']?.map((x) => ColumnInfo.fromMap(x))),
      figures: List<Figure>.from(map['figures']?.map((x) => Figure.fromMap(x))),
      totals: List<Figure>.from(map['totals']?.map((x) => Figure.fromMap(x))),
    );
  }

  String toJson() => json.encode(toMap());

  factory ReportDatum.fromJson(String source) => ReportDatum.fromMap(json.decode(source));
